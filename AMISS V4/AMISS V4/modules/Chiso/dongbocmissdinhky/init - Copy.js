...
function f_napcmiss() {
    try {
        ...
        var config = { connstr: "ConnectOracle_Amiss4", namesql: "AMISS_DONGBOCMISS.CalculateXmlCmiss_TheoKy3", callback: "f_result_NapCMIS" };
        var para = {
            v_tren: v_tren,
            v_duoi: v_duoi,
...
function f_cleartemp_dbcmis(thiss) {
    try {
        var config = { connstr: "ConnectOracle_Amiss4", namesql: "AMISS_DONGBOCMISS.clearTEMP_DBCMIS", callback: "f_result_clearTEMP_DBCMIS" };
        var para = {};
        ExecuteServiceSyns(config, para);
    } catch (e) {
        console.log(e);
...
function f_loadCMIS() {
    try {
        var config = { connstr: "ConnectOracle_Amiss4", namesql: "AMISS_DONGBOCMISS.GetCMISfromTEMP", callback: "result_loadCMIS" };
        var para = {};
        ExecuteServiceSyns(config, para);
...
function xuatexcel_cb(type) {
    try {
        ...
        var config = { connstr: "ConnectOracle_Amiss4", namesql: "AMISS_DONGBOCMISS.EXPORTFILEEXCELCMISS", callback: "f_result_checkfilexmltemdbcmissbackup_filecmis" };
        var para = {
...
function fn_XuatExcel_cmis() {
    try {
        ...
        var config = { connstr: "ConnectOracle_Amiss4", namesql: "AMISS_DONGBOCMISS.CalculateXmlCmiss_TheoKy3", namefile: namef_l };
        var para = {
            v_tren: v_tren,
            v_duoi: v_duoi,
            v_TimeInput: v_TimeInput,
...
function fn_dongy_file() {
    try {
        ...
        var config = { connstr: "ConnectOracle_Amiss4", namesql: "AMISS_DONGBOCMISS.CHECKFILEXMLTEMPDBCMISBACKUP", callback: "f_result_checkfilexmltemdbcmissbackup_filecmis" };
        var para = {
            v_IDRANDOM: idramdom_cmis
        };
        //console.log(para);
...
function f_save_filecmis(config, para, lst) {
    try{
        ...
        var config = { connstr: "ConnectOracle_Amiss4", namesql: "AMISS_DONGBOCMISS.SaveContentXmlCmiss", callback: "f_result_save_filecmis" };
        var para = {
            v_Code: v_Code,
...
function f_Historyfilenamexml() {
    try{
        ...
        var v_UserName = userinfo.usercode;
        var v_Code = userinfo.code;
        var config = { connstr: "ConnectOracle_Amiss4", namesql: "AMISS_DONGBOCMISS.HistoryFileNameXmlCmiss", callback: "f_result_Historyfilenamexml" };
        var para = {
            v_Code: v_Code,
            v_UserName: v_UserName
        };
...
function fn_export_historyfilexml() {
    ...
    try{
        var config = { connstr: "ConnectOracle_Amiss4", namesql: "AMISS_DONGBOCMISS.EXPORTHISTORYFILEXML", callback: "f_result_exprotfilenamexml" };
        var para = {
...
function fn_delete_historyfilexml() {
    try{
        var config = { connstr: "ConnectOracle_Amiss4", namesql: "AMISS_DONGBOCMISS.DELETEHISTORYFILEXML", callback: "f_result_deletehistoryfilexml" };
        var para = {
