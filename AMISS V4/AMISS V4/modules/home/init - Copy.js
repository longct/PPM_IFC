...
function f_GetData_ComboDL() {
    try {
        var config = { connstr: "ConnectOracle_Amiss4", namesql: "AMISS_CAYDULIEU.GetParentNodeAllTree", callback: "f_result_GetParentNodeAllTree" };
        var para = {
            v_Code: "01",
            v_TypeTree: "01"
        };
...
function f_getDt_ttkh(v_code, inday) {
    try {
        ...
        var config = { connstr: "ConnectOracle_Amiss4", namesql: "AMISS_LOIDIEMDO.THONGKELOI4", callback: "f_result_ttkh2" };
        var para = {
            v_Type: v_Type,
            v_Value: v_Value,
            v_From: v_From,
...
function f_getDt_ttkh2(v_code, inday) {
    try {
        ...
        var config = { connstr: "ConnectOracle_Amiss4", namesql: "AMISS_LOIDIEMDO.THONGKELOI3", callback: "f_result_ttkh" };
        var para = {
            v_Type: v_Type,
            v_Value: v_Value,
            v_From: v_From,
...
function f_GetData_cbSukien(v_code) {
    try {
        var config = { connstr: "ConnectOracle_Amiss4", namesql: "AMISS_CANHBAOCONGTO.EVENT_ThongKe", callback: "f_result_EVENT_ThongKe" };
        var para = {
            v_Type: 1,
            v_Value: v_code,
...
function f_GetData_cbVanhanh(v_code) {
    try {
        var config = { connstr: "ConnectOracle_Amiss4", namesql: "AMISS_CANHBAOVANHANH.ThongKeCanhBao", callback: "f_result_ThongKeCanhBao" };
        var para = {
            v_Type: 1,
            v_Value: v_code,
            v_From: '',
