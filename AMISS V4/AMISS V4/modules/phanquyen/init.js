...
function luuPhanquyen(record) {
    try {
        ...
        var config = { namesql: "PKG_PHANQUYEN.PHANQUYEN", callback: "f_result_luuPhanquyen", connstr: "ConnectOracle_Amiss4" };
        var para = {
            v_userid: record.uid,
            v_mid: record.mid,
...
function loaddanhdanhtaikhoan() {
    try {
        ...
        var config = { connstr: "ConnectOracle_Amiss4", namesql: "PKG_DANHSACHTAIKHOAN.DANHSACHTAIKHOAN", callback: "result_danhsachtaikhoan" };
        var para = {
