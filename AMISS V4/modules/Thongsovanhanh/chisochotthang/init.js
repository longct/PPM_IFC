$(document).ready(function () {
    ...
    try {
        ...
        $("#dtTuNgay").val(gettimenow_cscthang());
        $("#dtDenNgay").val(gettimenow_cscthang());
...
function excel(type) {
    if (type == 1) {
        ...
        var config = { connstr: "ConnectOracle_Amiss4", namesql: "PKG_CHISOCHOTNGAY.CSCTHANG_KHACHHANG_PAGE", namefile: namef };
        var para = {
            v_MeterId: meterid,
            v_Socongto: sct,
            v_dFrom: tuthang,
        ...
        var config = { connstr: "ConnectOracle_Amiss4", namesql: "PKG_CHISOCHOTNGAY.CSCTHANG_LISTKH_PAGE", namefile: namef_l };
        var para = {
            v_Value: code,
            v_From: thang,
            v_pagenum: 0,
