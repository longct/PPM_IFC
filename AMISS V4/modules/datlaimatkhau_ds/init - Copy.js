...
function GetListUser(page) {
    try {
        ...
        var config = { connstr: "ConnectOracle_Amiss4", namesql: "AMISS_DATLAIMATKHAU.DANHSACHTAIKHOAN", callback: "f_result_danhsachtaikhoan_dlmk" };
        var para = {
...
function f_thaydoimatkhau_dlmk() {
    try {
        ...
        var userinfo = JSON.parse(localStorage.getItem('userinfo'));
        var config = { connstr: "ConnectOracle_Amiss4", namesql: "AMISS_DATLAIMATKHAU.THAYMATKHAU", callback: "f_result_resetpassword_dlmk" };
        var para = {
...
function fn_save_unlock_dlmk() {
    try {
        var config = { connstr: "ConnectOracle_Amiss4", namesql: "AMISS_DATLAIMATKHAU.MOTAIKHOAN", callback: "f_result_save_unlock_dlmk" };
        var para = {
