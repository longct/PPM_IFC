...
function getTreeForUser(usercode) {
    try {
        ...
        var config = { namesql: "AMISS_CAYDULIEU.GetTreeAll", callback: "f_result_getTreeForUser", connstr: "ConnectOracle_Amiss4" };
        var para = {
...
function loadProvincetoCombo(code) {
    try {
        var config = { connstr: "ConnectOracle_Amiss4", namesql: "AMISS_CAYDULIEU.GetProvinceForCombo", callback: "result_loadProvince" };
        var para = {
            v_Code: code,
            v_UserCode: 1,
            v_isSub: 1
...
function loadTramToCombo(code) {
    try {
        var config = { connstr: "ConnectOracle_Amiss4", namesql: "AMISS_CAYDULIEU.GetProvinceForCombo", callback: "result_loadTram" };
        var para = {
            v_Code: code,
            v_UserCode: 1,
            v_isSub: 1
...
function GetTreeAll(code,type) {
    try {
        var config = { connstr: "ConnectOracle_Amiss4", namesql: "AMISS_CAYDULIEU.GetTreeAll", callback: "result_GetTreeAll" };
        var para = {
            V_USERID: 1,
            V_PERMISSION: 1,
            V_CODE: code,
