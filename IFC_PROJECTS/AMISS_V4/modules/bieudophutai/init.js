...
function get_BDPT_KH() {
    try {
        ...
        var config = { connstr: "ConnectOracle233", namesql: "AMISS_VANHANH.BieuDoPhuTai_KHACHHANG", callback: "draw_bdpt" };
        var para = {
            v_MeterId: meterid,
            v_Socongto: sct,
            v_From: tungay,
...
function excel() {
    ...
    var config = { connstr: "ConnectOracle233", namesql: "AMISS_VANHANH.BieuDoPhuTai_KHACHHANG", namefile: namef_l };
    var para = {
        v_MeterId: meterid,
        v_Socongto: sct,
        v_From: tungay,
