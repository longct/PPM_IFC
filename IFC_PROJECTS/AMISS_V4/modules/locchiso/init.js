...
function get_locthongso(page) {
    try {
        ...
        var config = { connstr: "ConnectOracle233", namesql: "AMISS_VANHANH.BAOCAOTHONGTIN", callback: "result_locthongso" };
        var para = {
...
function excel_locthongso() {
    try {
      ...
      //  var namef_l = 'LOCBAOCAOCAO';
        ...
        var config = { connstr: "ConnectOracle233", namesql: "AMISS_VANHANH.BAOCAOTHONGTIN", namefile: namef_l };
        var para = {
            v_Type: 1,//-- 1: Dienluc(Code); 2:Tram(CodeDM)  3:Nhom(GroupId) 4: List ID;
            v_Value: code,
            v_From: '',
