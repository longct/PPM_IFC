...
function get_BCSL() {
    try {
        ...
        var config = { connstr: "ConnectOracle233", namesql: "AMISS_SANLUONG.SANLUONG_CHISOCHOT", callback: "result_BCSL" };
        var para = {
...
function excel() {
    ...
    var config = { connstr: "ConnectOracle233", namesql: "AMISS_SANLUONG.SANLUONG_CHISOCHOT", namefile: namef_l };
    var para = {
        v_Type: 1,//-- 1: Dienluc(Code); 2: Nhom(UserId); 3:Nhom(GroupId); 4:Tram(CodeDM)
        v_Value: code,
        v_From: '',
