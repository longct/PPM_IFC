...
$(document).ready(function () {
    try {
        setTitle("Báo cáo tình hình lỗi cần xử lý");
        //loadDoiSoat(1);
...
function laydulieu(page) {
    try {
        ...
        var maduan = item.value.split("_")[0];
        //var p = getAllIdMod();
        var config = { connstr: "Oracle_AmosiDefault", namesql: "PKG_BAOCAOHETHONG.TINHHINHLOI", callback: "result_laydulieu" };
        var para = {
            v_maduan: maduan
            //v_pagenum: page,
            //v_numrecs: countpage,
    ...
    try {
        ...
        $.each(data, function (key, val) {
            ...
            row += "<tr><td>"
                ...
                + val.pha3_l + "</td><td>"
                + val.pha1_l + "</td><td>"
                + val.diemdo_l13 + "</td><td>"
                + val.diemdo_l11 + "</td><td>"
                + val.diemdo_l23 + "</td><td>"
                + val.diemdo_l21 + "</td>";
...
function XuatExcel_ttdd() {
    try {
        ...
        var config = {
            namefile: "Tinh-hinh-loi-can-xu-ly_" + gettimenow().replace("/", "-"),
        ...
        var colum = {
            kq: [
               ...
               { field: "diemdo_l13", name: "Ưu tiên loại 1 - 3 pha GPRS", type: "Text" },
               { field: "diemdo_l11", name: "Ưu tiên loại 1 - RF/PLC", type: "Text" },
               { field: "diemdo_l23", name: "Ưu tiên loại 2 - 3 pha GPRS", type: "Text" },
               { field: "diemdo_l21", name: "Ưu tiên loại 2 - RF/PLC", type: "Text" }
            ]
        };
