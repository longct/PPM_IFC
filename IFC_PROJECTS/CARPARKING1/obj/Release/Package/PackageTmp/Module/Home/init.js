...
function drowGrid_home(data)
{
    ...
    var header = "<tr><th class='tencot'>Tên cột</th>";
    var timeTucThoi = '<tr><td class="tencot2 thoigiandoc">Thời gian đọc</td>';
    var solist = '<tr><th>Số lít</th>';
    var dongia = '<tr><th>Đơn giá</th>';
    var thanhtien = '<tr><th>Thành tiền</th>';
    var timechot = '<tr><td class="tencot2 thoigiandoc">Thời điểm chốt</td>';
    var tongsolit = '<tr><th>Tổng số lít</th>';
    var tongsotien = '<tr><th>Tổng số tiền</th>';
    var sum = "";
    $.each(data, function (key, val) {
        ...
        timeTucThoi += '<td class="thoigiandoc thaythoidiemdoc_' + removeNull_home(val.macot) + '">' + removeNull_home(val.thoidiemcuoi) + '</td>';
        ...
        timechot += '<td class="thoigiandoctl thaythoidiemchot_' + removeNull_home(val.macot) + '">' + removeNull_home(val.thoidiem_chot) + '</td>';
        ...
        sum += "<tr>" + header + timeTucThoi + solist + dongia + thanhtien + timechot + tongsolit + tongsotien;
    ...
    tongsolit += "</tr>";
    tongsotien += "</tr>";
    sum =tenTramHead+ header + timeTucThoi + solist + dongia + thanhtien + timechot + tongsolit + tongsotien;
