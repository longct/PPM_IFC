...
function loadmauquyen_suathem(id) {
    try {
        clear_load_sua();
        idchungquyen = id;
        var config = { connstr: "ConnectEMS", namesql: "IDCHUNGQUYEN", callback: "resut_loadmauquyen_suathem" };
        var para = {
            v_IDCHUNG : id
        };
...
function layid_suaquyen() {
    try {
        ...
        var config = { connstr: "ConnectEMS", namesql: "SUAQUYENMOI", callback: "resut_capnhatquyen_sua" };
        var para = {
