...
function loadmauquyen() {
    try{
        var config = { connstr: "ConnectEMS", namesql: "LOADMAUQUYEN", callback: "resut_loadmauquyen" };
        var para = [];
...
function capnhatid() {
    try{
        ...
        console.log(dt);
        var config = { connstr: "ConnectEMS", namesql: "CAPNHATQUYENDANHSACH", callback: "resut_capnhatquyen" };
        var para = {
