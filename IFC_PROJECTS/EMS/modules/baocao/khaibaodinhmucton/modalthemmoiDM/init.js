...
function addThem_KBDM() {
    try {
        ...
        var para = {
            ...
            ThoiDiemKB: p.txt_thoigiankhaibao_kbdm,
            ...
            SLCapPhat: parseInt(p.txt_slvttbcapphat_kbdm),
...
function validatechitiet() {
    try {
        ...
        if (p.txt_slvttbcapphat_kbdm == '') return "Vui lòng nhập SL VTTB xin cấp phát sinh";
        if (p.txt_thoigiankhaibao_kbdm == '') return "Vui lòng nhập thời gian khai báo";
        return "";
    } catch (e) {
        console.log(e);
    }
...
function result_loadthongtin_kbdm(config, para, lst) {
    try {
        ...
        $("#txt_slvttbcapphat_kbdm").val(data[0].slcp);
