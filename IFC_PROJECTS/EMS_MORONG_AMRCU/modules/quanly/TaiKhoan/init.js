...
function lstbanmien_taikhoan() {
    try {
        ...
        var config = { namesql: "TB_Export_LstLoadByCode", callback: "f_result_lstbanmien_taikhoan", connstr: "ConnectEMS" };
        var para = {
...
function f_result_lstbanmien_taikhoan(config, para, lst) {
    try {
        var data = lst.data;
        dataToCob("cbkhobanmien_tttk", data, "code", "name", "-1", "--Chọn ban miền--");
    } catch (e) {
        console.log(e);
    }
}
