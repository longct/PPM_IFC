    ...
    try {
        ...
        $.each(data[4].kq4, function (key, val) {
            ...
            row +="<tr><td>"
                  ...
                  + val.name + "</td><td>"
                  + "<form class='form-inline' role=''form'><div class='form-group'><a class='btn btn-success btn-action' data-toggle='modal' href='#sua_nhacc' style='width: 65px;height: 30px;' id='btn_suacc" + val.code + "'>Sửa</a></div></form></td> </tr>";
