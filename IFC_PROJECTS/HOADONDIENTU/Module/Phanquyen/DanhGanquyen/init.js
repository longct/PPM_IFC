...
function lsttaikhoan() {
    try {
        ...
        var config = { connstr: "Oracle_HDDT", namesql: "HD_PHANQUYENNGUOIDUNG.LSTNGUOIDUNG", callback: "result_lsttaikhoan" };
        var para = {
...
function lsttaimau() {
    try {
        var userinfo = JSON.parse(localStorage.getItem("userinfo"));
        var config = { connstr: "Oracle_HDDT", namesql: "HD_PHANQUYENNGUOIDUNG.LSTMAU", callback: "result_lsttaimau" };
        var para = [];
        ExecuteServiceSyns(config, para);
    } catch (e) {
        console.log(e);
...
function loadmauquyen_apquyen(id) {
    try {
        var config = { connstr: "Oracle_HDDT", namesql: "HD_PHANQUYEN.IDCHUNGQUYEN", callback: "resut_loadmauquyen_apquyen" };
        var para = {
            v_IDCHUNG: id
        };
        ExecuteServiceSyns(config, para);
...
function loadquyentheouser(id) {
    try {
        var config = { connstr: "Oracle_HDDT", namesql: "HD_PHANQUYENNGUOIDUNG.LOADPHANQUYENTAIKHOAN", callback: "resut_loadmauquyen_apquyen" };
        var para = {
            v_USERID: id
        };
        ExecuteServiceSyns(config, para);
...
function capnhatquyen_taikhoan() {
    try{
        var userinfo = JSON.parse(localStorage.getItem("userinfo"));
        var config = { connstr: "Oracle_HDDT", namesql: "HD_PHANQUYENNGUOIDUNG.CAPQUYENUSER", callback: "resut_capnhatquyen_taikhoan" };
        var para = {
            v_USERID: userinfo.userid,
