...
function loadmodulesid(id) {
    try {
        ...
        var config = { connstr: "Oracle_HDDT", namesql: "HD_PHANQUYEN.IDCLASS", callback: "result_loadmodulesid" };
        var para = {v_ID: id};
...
function capnhatfrom() {
    try {
        ...
        var p = getAllIdMod();
        var config = { connstr: "Oracle_HDDT", namesql: "HD_PHANQUYEN.CAPNHATCLASS", callback: "result_capnhatfrom" };
        var para = {
            v_ID: idmd,
