...
function loadbangxml(data) {
    try{
        ...
        $.each(data[3].kq3, function (key, val) {
            ...
            //var result = $.grep(data[3].kq3, function (e) { return e.BCS == val.BCS; });
            //var row1 = "";
            ...
            //        + '' + "</td><td>"
            //        + val1.DONGIA + "</td><td>"
            //        + val1.THANHTIEN + "</td></tr>";

               

            //});
            
            $("#table_xml_xacthuc").append(row );
           // row1 = "";
        });
        $(".VC").hide();

        $("#thonghopdong").append("<div class='bottom-mar-50'></div>");
    } catch (e) {
        console.log(e);
    }
}
