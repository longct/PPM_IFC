...
var urli = "http://14.177.66.131:5566/ServiceSqlOracleNew";
//var urli = "http://14.177.234.76/ServiceHoaDonDienTuSbm";
//var urli = "http://localhost:22660";
//var urli = "http://localhost:8005/ServiceChung";
//var urli = "http://192.168.1.246/ServiceChung"
var serialNumber_Sign = "YourSerialNumber";
var pathFileTxt = "C:\\KYFILE.txt";
//Sql1Pha3Pha
...
function api_uploadFileHopDongScan(config, fd) {
    try {
        var lstData = null;
        $.ajax({
            type: 'POST',
            url: urli + '/Home/UploadFileHopDongScan',
            data: fd,
            processData: false,
            contentType: false,
            dataType: "json",
