...
$(document).ready(function () {
    $('@modkey_chart').css('display','none');
});

function f_@modkey_drawChart(type)
{
    var data = localStorage.getItem("tonghopsolieutheongay_data");
    var category = localStorage.getItem("tonghopsolieutheongay_category");
    f_@modkey_Chart(data, category,type);
}

function f_@modkey_Chart(serieData, category,type) {
