...
function f_result_login(config, para, lst) {
    try {
        ...
        //var user = { server: lst.data[0].ip, port: lst.data[0].port, tendangnhap: lst.data[0].tendangnhap, userid: lst.data[0].userid };
        //console.log(user);
...
//function login(p) {
//    try {
//        //var config = { "namesql": "HT_LOGIN.LOADUSER", connstr: "Oracle_HTLAPDAT" };
//        var config = { connstr: "ConnectSql_HTLD", namesql: "HTLD_LOGIN" };
