    ...
    try {
        ...
        var str = '<tr value ="'+idbong+'" class="'+trangthai+'">' +
                ...
                '<td id="thaymuccongsuat_tqtctb' + idbong + '" class="thaythewaid">-</td>' +
                 '<td id="thaytrangthai_tqtctb' + idbong + '"><img src="img/gmap/trangthai' + setnull(trangthai) + '.png" title="' + hienthitrangthai + '"></img></td>' +
            '</tr>';
        ...
        $.each(lst.data, function (key, val) {
           // if (parseInt(val.muccongsuat) > 0) {
            $("#thaymuccongsuat_tqtctb" + val.idbong).html((val.muccongsuat == "0" ? "-" : val.muccongsuat));
                ...
                $("#thaytrangthai_tqtctb" + val.idbong).html('<img src="img/gmap/trangthai' + setnull(val.trangthai) + '.png" title="' + val.hienthitrangthai + '"></img>');
           // }
        });
        checkFinish_tqtctb();
    } catch (e) { console.log(e); }
