...
var urli = "http://streetlight.ifc.com.vn:1005/ServiceStreetLight";
    ...
    try {
        ...
        $.ajax({
            ...
            success: function (data, textStatus, jqXHR) {
                ...
                window.open(urli + "/home/DownloadFileHoaDonHopDong/" + config.filecreat);
            },
            complete: function () {
            },
            error: function (jqXHR, textStatus, errorThrown) {
