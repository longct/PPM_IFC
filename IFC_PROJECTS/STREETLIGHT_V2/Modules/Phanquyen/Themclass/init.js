$(document).ready(function () {
    try {
        ...
        $("#btn_them_pquyen").click(function () {
            ...
            f_confimYesNo("Thêm mới chức năng", "Bỏ qua", "Xác nhận", function () {
                themmoi();
            });
        });
...
function themmoi() {
    try {
        ...
        var p = getAllIdMod();
        var config = { connstr: "ConnectOracleStreetLight", namesql: "HD_PHANQUYEN.THEMCLASS", callback: "result_themmoi" };
        var para = {
