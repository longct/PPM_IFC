...
function loadmauquyen() {
    try{
        var config = { connstr: "ConnectOracleStreetLight", namesql: "HD_PHANQUYEN.LOADMAUQUYEN", callback: "resut_loadmauquyen" };
        var para = [];
...
function capnhatquyen() {
    ...
    try {
        var userinfo = JSON.parse(localStorage.getItem("userinfo"));
        var config = { connstr: "ConnectOracleStreetLight", namesql: "HD_PHANQUYEN.CAPNHATQUYENDANHSACH", callback: "resut_capnhatquyen" };
        var para = {
