...
function f_result_loadthongtinidbong_suabong(config, para, lst) {
    try {
        ...
        setValToTxt("cb_phabong_suattbong", data[0].phabong);
    } catch (e) {
        console.log(e);
    }
}
function checkvalidate_suabong() {
    try {
        ...
        if (p.cb_phabong_suattbong == '-1' || p.cb_phabong_suattbong=="") return "Vui lòng chọn pha"
...
function capnhatthongtin_suatbong() {
    try{
        ...
        var para = {
            ...
            v_phabong: p.cb_phabong_suattbong
        };
        ExecuteServiceSyns(config, para, false);
    } catch (e) {
        console.log(e);
