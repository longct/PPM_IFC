                    ...
                    if (i == 0) {
                        div += '<div class="item active">' +
                            '<div class="panel-body body-chitiettu">' +
                                ...
                                '<td style="text-align:center"><span title="Bóng cháy" class="text-primary"><img src="img/bong_tree3.png" /></span> </td>' +
                                ...
                                '<span class="text-primary"><i class="fa fa-cogs"></i><span class="text-bold"> Chế độ:</span><br/><span class="text-danger" id="chedotu' + val.id + '"></span></span><br />' +
                            '</div>' +
                          '</div>';
...
function f_result_get_chedotu(config, para, lst) {
    ...
    if (tt == null) {
        ...
        else if (ct[1] == "TUCTHOI") setting = "Tức thời <small class='text-primary'>(Thời điểm bắt đầu: " + ct[2] + ", còn lại " + countdown + " phút.)</small>";
