...
$(document).ready(function () {
    ...
    try {
        ...
        $("#locpha_tqtctb").change(function () {
            ...
            if (p.locpha_tqtctb == "A") {
                $(".phaA").show();
                $(".phaB").hide();
                $(".phaC").hide();
            }

            if (p.locpha_tqtctb == "B") {
                $(".phaA").hide();
                $(".phaB").show();
                $(".phaC").hide();
            }

            if (p.locpha_tqtctb == "C") {
                $(".phaA").hide();
                $(".phaB").hide();
                $(".phaC").show();
            }
...
function f_htmlRow_tqtctb(val) {
    try {
        var str = '<tr value ="' + val.idbong + '" class="pha'+val.thuocpha+'" >' +
                ...
                '<td>' + (setnull(val.chedo) + setnull(val.thoigiandim)) + '</td>' +
                '<td>' + setnull(val.mucdim) + '</td>' +
                '<td>' + setnull(val.mucdimtaithoidiem) + '</td>' +
                '<td>' + setnull(val.dienap) + '</td>' +
                '<td>' + setnull(val.dong) + '</td>' +
                '<td>' + setnull(val.congsuat) + '</td>' +
                '<td style="text-align:center">' + setnull(val.thuocpha) + '</td>' +
