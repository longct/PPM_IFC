...
function f_result_loadChiTietBong_tqtctb(config, para, lst)
{
    try
    {
        ...
        $.each(lst.data, function (key, val) {
            ...
            var str = f_htmlRow_tqtctb(val.idrfbong,val.idbong, val.tenbong, val.mucdim, val.trangthai, val.chedo, val.thoigiandim, val.hienthitrangthai)
...
function f_htmlRow_tqtctb(idrfbong,idbong, tenbong, mucdim, trangthai, chedo, thoigiandim, hienthitrangthai)
{
    try {
        ...
        var str = '<tr value ="'+idbong+'" class="'+trangthai+'">' +
                ...
                '<td id="thaymuccongsuat_tqtctb' + idbong + '" class="thaythewaid">-</td>' +
                 '<td id="thaytrangthai_tqtctb' + idbong + '"><img src="img/trangthai' + setnull(trangthai) + '.png" title="' + hienthitrangthai + '"></img></td>' +
                  '<td><a class="btn btn-success btn-action"  data-toggle="modal" href="#baocao_tsvhbong"  id="xembong_tsvbong' + idrfbong + '" >Xem</a> </td>' +
            '</tr>';
...
function f_updateResultDtt_tqtctb() {
    try {
        ...
        if (infodoctranthaibong_tqtctb == null || infodoctranthaibong_tqtctb == undefined)
            return;
        var para = infodoctranthaibong_tqtctb;
        ExecuteServiceSyns(config, para);
    } catch (e) { console.log(e); }
}
