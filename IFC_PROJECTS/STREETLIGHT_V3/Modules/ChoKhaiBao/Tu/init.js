    ...
    try {
        ...
        $.each(data, function (key, val) {
            ...
            row += "<tr><td>"
                ...
                + setnull(val.code) + "</td><td>"
                + " <form class='form-inline' role=''form'><div class='form-group'><a class='btn btn-success btn-action classquyen_sua' data-toggle='modal' href='#sua_ttcongto' value='" + val.id + "' id='btn_suathongcongto" + val.id + "'>Sửa</a></div> </form></td></tr>";
