...
function loaddanhsachmodule(page) {
    try{
        var config = { connstr: "ConnectOracleStreetLight", namesql: "HD_PHANQUYEN.THONGDANHSACHQUYEN", callback: "resut_loaddanhsachmodule" };
        var para = {
            v_pagenum: page,
            v_numrecs:countpage
        };
...
function Xoathongtin(id) {
    try{
        ...
        var config = { connstr: "ConnectOracleStreetLight", namesql: "HD_PHANQUYEN.XOACLASS", callback: "resut_Xoathongtin" };
        var para = {
            v_ID: id,
