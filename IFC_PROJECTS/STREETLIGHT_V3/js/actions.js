...
function page_content_onresize(){
    ...
    $(".sidebar .sidebar-wrapper").height(vpH - 100);
    ...
    var tree_panel = $("#tree_panel");

    if (content.height() < vpH - content_minus) {
        //console.log(content.height());
        tree_panel.css("max-height", content.height() - 150);
        tree_panel.css("min-height", 400);
...
function panel_fullscreen(panel){    
    ...
    if(panel.hasClass("panel-fullscreened")){
        ...
        panel.find("#google_ptm_map").height(500);
        loadMap();
        $(window).resize();
    }else{
